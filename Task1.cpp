...
public:
	virtual std::string getName() const { return "Task1"; }
...
void Task1::initialize(cWorld* world, cCamera* camera)
{
...
void Task1::updateGraphics()
{

}

void Task1::updateHaptics(cGenericHapticDevice* hapticDevice, double timeStep, double totalTime)
{
	...
	//First wall
	if (newPosition.y() > 0.2 && newPosition.y() < 0.4) {
		cVector3d proxyPos;
